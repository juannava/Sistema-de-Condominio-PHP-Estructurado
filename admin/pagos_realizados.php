    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                    <label for="fecha" class="control-label col-md-3 col-sm-3 col-xs-12">Fecha de Pago </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="fecha" class="form-control col-md-7 col-xs-12" type="date" name="fecha" min="2015-01-01" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                </div>
