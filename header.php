...
<?php include("conexion/restriccion.php"); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <link href="../mediacss/maps/jquery-jvectormap-2.0.1.css" rel="stylesheet" type="text/css" />
        <link href="../media/css/icheck/flat/green.css" rel="stylesheet" />
        <link href="../media/css/floatexamples.css" rel="stylesheet" type="text/css" />
